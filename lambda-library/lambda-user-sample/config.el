...
;;;;; Set User Elisp Dir
(setq lem-user-elisp-dir "~/code/lisp-projects/")

;;;;; Org Settings
;; Org Directories

(setopt org-directory user-org-directory
...
;;;;; Citations
(setq lem-bibliography (concat (getenv "HOME") "/sync/org/bib/zotero-biblatex.bib"))
;;(setq lem-bib-notes (concat (getenv "HOME") "/Work/projects/notebook/content-org/ref-notes"))
(setq lem-bib-notes (concat (getenv "HOME") "/Documents/notes/ref-notes"))
...
(with-eval-after-load (or 'consult-notes
  ...
  (setopt consult-notes-org-headings-files `(,(concat org-directory "roam/workflow/inbox.org")
                                             ,(concat org-directory "roam/workflow/project.org")
                                             ,(concat org-directory "roam/workflow/contacts.org")
                                             ,(concat org-directory "roam/workflow/link.org")
                                             ,(concat org-directory "elfeed/elfeed.org")))
